...
namespace XCSJ.PluginVehicleDrive.Controllers
{
	...
	[Name("车灯控制器")]
	[Tip("控制近光灯、远光灯、雾灯、刹车灯、倒车灯和指示灯的亮灭与闪烁", "Control the on, off and flashing of low beam lamp, high beam lamp, fog lamp, brake lamp, reversing lamp and indicator lamp")]
