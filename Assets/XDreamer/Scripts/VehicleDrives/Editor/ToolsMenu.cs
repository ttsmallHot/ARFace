...
namespace XCSJ.EditorVehicleDrive
{
    ...
    public static class ToolsMenu
    {
        ...
        /// <returns></returns>
        [Tool(VehicleDriveCategory.Title, nameof(VehicleDriveManger), rootType = typeof(VehicleDriveManger), index = 1, groupRule = EToolGroupRule.None)]
        [XCSJ.Attributes.Icon(EIcon.Motorcycle)]
        [Name("二轮车")]
        [RequireManager(typeof(VehicleDriveManger))]
        [Manual(typeof(AutoRotationVehicle))]
        ...
        /// <param name="toolContext"></param>
        /// <returns></returns>
        [Tool(VehicleDriveCategory.Title, nameof(VehicleDriveManger), rootType = typeof(VehicleDriveManger), index = 2, groupRule = EToolGroupRule.None)]
        [XCSJ.Attributes.Icon(EIcon.Tricycle)]
        [Name("三轮车")]
        [RequireManager(typeof(VehicleDriveManger))]
        [Manual(typeof(VehicleController))]
        ...
        /// <param name="toolContext"></param>
        /// <returns></returns>
        [Tool(VehicleDriveCategory.Title, nameof(VehicleDriveManger), rootType = typeof(VehicleDriveManger), index = 3, groupRule = EToolGroupRule.None)]
        [XCSJ.Attributes.Icon(EIcon.SpotCar)]
        [Name("四轮车")]
        [RequireManager(typeof(VehicleDriveManger))]
        [Manual(typeof(VehicleDriver))]
        ...
        /// <param name="toolContext"></param>
        /// <returns></returns>
        [Tool(VehicleDriveCategory.Title, nameof(VehicleDriveManger), rootType = typeof(VehicleDriveManger), index = 4, groupRule = EToolGroupRule.None)]
        [XCSJ.Attributes.Icon(EIcon.Truck)]
        [Name("六轮车")]
        [RequireManager(typeof(VehicleDriveManger))]
        [Manual(typeof(VehicleHUD))]
        ...
        /// <param name="toolContext"></param>
        /// <returns></returns>
        [Tool(VehicleDriveCategory.Title, nameof(VehicleDriveManger), rootType = typeof(Canvas), needRootParentIsNull = true, index = 4, groupRule = EToolGroupRule.None)]
        [XCSJ.Attributes.Icon(EIcon.UI)]
        [Name("车辆输入界面")]
        [RequireManager(typeof(VehicleDriveManger))]
        [Manual(typeof(VehicleUIInput))]
        public static void CreateVehicleUIController(ToolContext toolContext)
        {
            EditorXGUI.Tools.ToolsMenu.CreateUIToolAndStretchHV(toolContext, () => EditorToolsHelperExtension.LoadPrefab_DefaultXDreamerPath("车辆驾驶/车辆输入界面.prefab"));
        }
