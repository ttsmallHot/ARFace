...
namespace XCSJ.EditorSMS.States.Show
{
    ...
    /// 步骤索引界面
    /// </summary>
    [XCSJ.Languages.LanguageFileOutput]
    public static class UIPlanTreeViewEditor
    {
        ...
        [Tool(XGUICategory.Controller, nameof(XGUIManager), rootType = typeof(Canvas), needRootParentIsNull = true, groupRule = EToolGroupRule.Create)]
        [Name("步骤索引界面")]
