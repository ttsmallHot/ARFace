...
namespace XCSJ.PluginNetInteract.CNScripts
{
    ...
    /// </summary>
    [Name("脚本ID")]
    [ScriptEnum(typeof(NetInteractManager))]
    public enum EScriptsID
    {
        ...
        /// 网络交互
        /// </summary>
        [ScriptName(NetInteractCategory.Title, nameof(NetInteract), EGrammarType.Category)]
        [ScriptDescription(NetInteractCategory.Title + "操作的目录")]
        #endregion
        NetInteract,
