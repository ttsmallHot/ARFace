...
namespace XCSJ.Extension.Base.Maths
{
    ...
    public static class MathExtension
    {
        ...
        /// <param name="v3"></param>
        /// <returns></returns>
        public static Vector3 ToVector3(this V3F v3) => new Vector3(v3.x, v3.y, v3.z);
        ...
        /// <param name="v3"></param>
        /// <returns></returns>
        public static Vector3 ToVector3(this V3D v3) => new Vector3((float)v3.x, (float)v3.y, (float)v3.z);
        ...
        /// <param name="v2"></param>
        /// <returns></returns>
        public static Vector2 ToVector2(this V2F v2) => new Vector2(v2.x, v2.y);
        ...
        /// <returns></returns>
        public static Rect ToRect(this RectF rectF) => new Rect(rectF.x, rectF.y, rectF.width, rectF.height);
    }
}