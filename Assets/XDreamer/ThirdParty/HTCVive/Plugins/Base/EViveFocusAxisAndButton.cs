...
namespace XCSJ.PluginHTCVive.Base
{
    ...
    public static class ViveFocusAxisAndButtonExtension
    {
        ...
        /// <returns></returns>
        public static bool TryGetAxis2DValue(this EViveFocusAxis2D axisArea, EVRDeviceType deviceType, out Vector2 value)
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static bool GetAbsValue(this EViveFocusAxisAndButton axisAndButton, EVRDeviceType deviceType, out float value)
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static bool TryGetValue(this EViveFocusAxisAndButton axisAndButton, EVRDeviceType deviceType, out float value)
        {
#if XDREAMER_STEAMVR
        ...
        /// <returns></returns>
        public static bool IsPressed(this EViveFocusAxisAndButton axisAndButton, EVRDeviceType deviceType, float deadZone = 0.5f)
        {
#if XDREAMER_STEAMVR
            if (SteamVRHelper.InitSteamVRInput())
            {
